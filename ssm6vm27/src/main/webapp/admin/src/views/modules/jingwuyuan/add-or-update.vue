...
export default {
	...
	lianxifangshi : false,
            ...
            ruleForm: {
                	        jingwuhao: '',
                                  ...
                                  rules: {
                  jingwuhao: [
                            { required: true, message: '警务号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jingwuyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jingwuyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
