<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="警务号" prop="jingwuhao">
          <el-input v-model="ruleForm.jingwuhao" 
              placeholder="警务号" clearable  :readonly="ro.jingwuhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="警务号" prop="jingwuhao">
              <el-input v-model="ruleForm.jingwuhao" 
                placeholder="警务号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.touxiang" label="头像" prop="touxiang">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.touxiang.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="出勤时间" prop="chuqinshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.chuqinshijian" 
                type="datetime"
                placeholder="出勤时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chuqinshijian" label="出勤时间" prop="chuqinshijian">
              <el-input v-model="ruleForm.chuqinshijian" 
                placeholder="出勤时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="出勤类型" prop="chuqinleixing">
          <el-select v-model="ruleForm.chuqinleixing" placeholder="请选择出勤类型">
            <el-option
                v-for="(item,index) in chuqinleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="出勤类型" prop="chuqinleixing">
	      <el-input v-model="ruleForm.chuqinleixing"
                placeholder="出勤类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
                      		if(json.jingwuhao!=''&&json.jingwuhao){
              		this.ruleForm.jingwuhao = json.jingwuhao
		}
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `chuqinxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chuqinxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
