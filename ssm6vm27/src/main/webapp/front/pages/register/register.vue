<template>
	<view class="content">
		<view class="logo" v-if="false">
			<image :style='{"boxShadow":"0 0 16rpx #59f43e","borderColor":"#ccc","borderRadius":"40rpx","borderWidth":"2rpx","width":"160rpx","borderStyle":"solid","url":"http://codegen.caihongy.cn/20210307/0d4dd251885244029545be4cf0eb6399.jpg","isShow":false,"height":"160rpx"}' src='http://codegen.caihongy.cn/20210307/0d4dd251885244029545be4cf0eb6399.jpg' mode="aspectFill"></image>
		</view>
		<view v-if="tableName=='jingwuyuan'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(51, 153, 153, 1)","backgroundColor":"#fff","borderRadius":"20rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.jingwuhao" type="text" class="uni-input" name="" placeholder="警务号" />
		</view>
		<view v-if="tableName=='jingwuyuan'" class="uni-form-item uni-column">
	...
	export default {
		...
		async onLoad() {
			...
			if(this.tableName=='jingwuyuan'){
				...
				this.ruleForm.xingbie=this.jingwuyuanxingbieOptions[0]
			}
